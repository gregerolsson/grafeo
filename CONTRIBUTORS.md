...
- **temporaryfix** ([@temporaryfix](https://github.com/temporaryfix)): CompactStore columnar read-optimized store, RFC ([#199](https://github.com/GrafeoDB/grafeo/issues/199)), implementation ([#204](https://github.com/GrafeoDB/grafeo/pull/204)); BM25 text scan operator, hybrid query planner pushdown, Float64/Float32Vector column codecs, post-compact index fix ([#286](https://github.com/GrafeoDB/grafeo/pull/286))
